...
<Callout type="info">
  You can also create or paste your own SSH Key, you can edit the Private Key and Public Key fields
  without restrictions, make sure to use the correct format for the key type you are using.
</Callout>
