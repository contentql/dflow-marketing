        ...
        <Container>
          <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
            ...
            <p className="text-base md:text-lg text-center text-muted-foreground mt-6">
              Transform your marketing with AI-powered automation. Create campaigns faster, generate
              better content, and make smarter decisions in minutes.
            </p>
          </div>
        </Container>
  ...
  return (
    <div
      className={cn(
        ...
        plan.title === 'Mastermind' && 'border-primary',
      )}
    >
      ...
      <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
        <Button
          size="lg"
          variant={plan.title === 'Mastermind' ? 'default' : 'white'}
          className="w-full"
        >
          {plan.buttonText}
        </Button>
