        ...
        <div className="">
          {isGeneratePasswordSuccess ? (
            <Alert variant="success" className="mb-12">
              <AlertDescription>An email verification has been successfully sent.</AlertDescription>
            </Alert>
          ) : isGeneratePasswordError ? (
            <Alert variant="danger" className="mb-12">
              <AlertDescription>{generatePasswordError.message}</AlertDescription>
            </Alert>
          ) : null}
          <h1 className="mb-1 text-3xl font-semibold">Forgot your password</h1>
          <p className="mb-6 text-muted-foreground">
            Forgot your password? Please enter your email we&apos;ll send you reset link
          </p>
        </div>
